...
//---------------------------------------------------------------------------------------------
    ...
    if (currentDecisionRadio) {
        ...
        document.querySelector('input[name="newsDecision"][value="weiss_nicht"]').checked = true;
...
//---------------------------------------------------------------------------------------------
    try {
        ...
        NEWSDECISION = decision ? decision.toString().trim() : "weiss_nicht";
        ...
        NEWSDECISION = "weiss_nicht"; // Fallback
    }
}
